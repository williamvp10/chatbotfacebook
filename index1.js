...
//global var
var user;
var varPreguntaModificarActuador = false;
...
app.post('/webhook/', function (req, res) {
    ...
    for (let i = 0; i < messaging_events.length; i++) {
        ...
        let text = "";
        if (varPreguntaModificarActuador) {
            var type = "";
            if (varPreguntaModificarActuador) {
                type = "requestModificarActuador";
            }
            varPreguntaModificarActuador = false;
...
function selectTypeBotMessage(sender, body) {
    ...
    if (botOut.botUtterance !== null) {
        if (botOut.type !== null) {
            ...
            var t11 = "PreguntaModificarActuador";
            ...
            if (n1 === 0) {
                ...
                varPreguntaModificarActuador = true;
                sendTextMessage(sender, botOut.botUtterance);
            } else if (n12 === 0) {
                sendTextMessageList(sender, botOut)
                if (botOut.buttons.length === 0) {
