...
function sendTextMessage(sender, text) {
    if (text != 'null') {
        let messageData = {"attachment": {
                "type": "image",
                "payload": {
                    "url": "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/Paisaje_de_Las_Juntas_del_departamento_Ambato%2C_en_Catamarca%2C_Argentina..JPG/320px-Paisaje_de_Las_Juntas_del_departamento_Ambato%2C_en_Catamarca%2C_Argentina..JPG"
                }
            }
        }
        request({
